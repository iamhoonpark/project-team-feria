...
<body>
    ...
    <div id="wrapReservation">
        ...
        <div class="reservation_map">
            <h3>위치</h3>
            <input class="text_local" type="text" placeholder="수원시 권선구 권종로 99 벽산한성아파트" disabled>
            <div id="map"></div>
        </div>
        <div class="wrap_bibe_list">
            ...
            <div class="bibe_list">
                <ul>
                    <li class="bibe">
                        <img src="img/술1.jpg">
                        <div class="bibe_categories">과실주</div>
                        <div class="icon"><i class="fas fa-scroll"></i></div>
                        <div class="bibe_name">캔터키</div><!--나중에 글자수 제한-->
                        <div class="bibe_size">n 병 750ml</div>
                        <div class="profile_box">
                            <img class="profile_img" src="img/user.png" />
                            <img class="pie_img" src="img/pie1.jpg" />
                            <span class="user_name">모히또</span>
                    ...
                    <li class="bibe">
                        ...
                        <div class="bibe_categories">과실주</div>
                        <div class="icon"><i class="fas fa-scroll"></i></div>
                        <div class="bibe_name">돔페리</div><!--나중에 글자수 제한-->
                        <div class="bibe_size">n 병 750ml</div>
                        <div class="profile_box">
                            <img class="profile_img" src="img/user.png" />
                            <img class="pie_img" src="img/pie1.jpg" />
