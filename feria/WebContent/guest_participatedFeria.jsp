    ...
    <div class="wrap_attend_list">
        ...
        <div class="wrap_feria_attend">
            <ul class="list_attend_feria">
                <li class="attend_feria"  data-title="광란의 백반파티 개꿀맛" data-lat=" 37.7637611" data-lng="128.8990861">
                    <img src="img/Bob1.jpg" alt="밥1">
                    <span class="flag flag_b">B</span>
                    <div class="feria_name">광란의 백반파티 개꿀맛</div>
                    <div class="reservation_time">2020.07.12</div>
                    <button type="submit" class="situation" name="noneOpen">비공개</button>
                    <div class="attend_pin" style="background-color: #80d2ff"></div>
                </li>
                <li class="attend_feria"  data-title="광란의 백반파티 개꿀맛이에효 웰컴웰컴 사람꽉차빨리와효" data-lat=" 37.7637611" data-lng="128.8990861">
                    <img src="img/Bob1.jpg" alt="">
                    <span class="flag flag_s">S</span>
                    <div class="feria_name">광란의 백반파티 개꿀맛이에효 웰컴웰컴 사람꽉차빨리와효</div>
                    <div class="reservation_time">2020.07.17</div>
                    <button type="submit" class="situation" name="noneOpen">비공개</button>
                    <div class="attend_pin"></div>
                </li>
                <li class="attend_feria"  data-title="광란의 난리파티 개꿀맛" data-lat="37.7637611" data-lng="128.8990861">
                    <img src="img/Bob1.jpg" alt="">
                    <span class="flag flag_b">B</span>
                    <div class="feria_name">광란의 난리파티 개꿀맛</div>
                    <div class="reservation_time">2020.07.18</div>
                    <button type="submit" class="situation" name="noneOpen">비공개</button>
                    <div class="attend_pin"></div>
                </li>
                <li class="attend_feria" data-title="광란의 백반파티 개꿀맛" data-lat="33.4513931" data-lng="126.570738">
                    <img src="img/Bob1.jpg" alt="">
                    <span class="flag flag_s">S</span>
                    <div class="feria_name">광란의 백반파티 개꿀맛</div>
                    <div class="reservation_time">2020.07.26</div>
                    <button type="submit" class="situation" name="noneOpen">비공개</button>
                    <div class="attend_pin"></div>
                </li>
            </ul>
