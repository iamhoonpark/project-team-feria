...
<script type="text/template" id="cenaTmpl">
    ...
    <li class="wrap_cena_info flag flag_<@=cena.BS@>">
        <div class="wrap_list_cena_image"><img src="<@=cena.src@>" alt=""></div>
        <div class="wrap_list_cena_info">
            <h4><@=cena.title@></h4>
            <strong class="cena_category"><@=cena.kinds@></strong>
    ...
    function getCena() {
        ...
        $.ajax({
            ...
            success:function (json) {
                ...
                console.log(json[0].src);

                $listCena.append(cenaTmp({cenas:json})); //json이 뒤로
