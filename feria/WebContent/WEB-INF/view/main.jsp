				...
				<div class="list_feria">
					<ul>
						...
						<li class="feria flag_b flag"><a href="feria_detail.jsp">
								...
								<div class="btn_heart">
									<div>
										<input type="checkbox" class="checkbox" id="checkbox5" /> <label
											for="checkbox5"> <svg id="heart-svg"
												viewBox="467 392 58 57" xmlns="http://www.w3.org/2000/svg">
                                            <g id="Group" fill="none"
													fill-rule="evenodd" transform="translate(467 392)">
                                                <path
						...
						<li class="feria flag_s flag"><a href="feria_detail.jsp">
								...
								<div class="btn_heart">
									<div>
										<input type="checkbox" class="checkbox" id="checkbox6" /> <label
											for="checkbox6"> <svg id="heart-svg"
												viewBox="467 392 58 57" xmlns="http://www.w3.org/2000/svg">
                                            <g id="Group" fill="none"
													fill-rule="evenodd" transform="translate(467 392)">
                                                <path
